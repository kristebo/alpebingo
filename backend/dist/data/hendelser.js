...
exports.alpinHendelser = exports.kategorier = void 0;
exports.hentAlleKategorier = hentAlleKategorier;
exports.hentKategori = hentKategori;
exports.lagreKategori = lagreKategori;
exports.slettKategori = slettKategori;
exports.hentAlleHendelser = hentAlleHendelser;
exports.hentAktiveHendelser = hentAktiveHendelser;
exports.hentHendelse = hentHendelse;
exports.lagreHendelse = lagreHendelse;
exports.slettHendelse = slettHendelse;
exports.genererTilfeldigKort = genererTilfeldigKort;
exports.kategorier = new Map([
...
exports.alpinHendelser = new Map([
...
function hentAlleKategorier() {
    return Array.from(exports.kategorier.values());
}
function hentKategori(id) {
    return exports.kategorier.get(id);
}
function lagreKategori(kategori) {
    exports.kategorier.set(kategori.id, kategori);
}
function slettKategori(id) {
    return exports.kategorier.delete(id);
}
function hentAlleHendelser() {
    return Array.from(exports.alpinHendelser.values());
}
function hentAktiveHendelser() {
    return Array.from(exports.alpinHendelser.values()).filter(h => h.aktiv);
}
function hentHendelse(id) {
    return exports.alpinHendelser.get(id);
}
function lagreHendelse(hendelse) {
    exports.alpinHendelser.set(hendelse.id, hendelse);
}
function slettHendelse(id) {
    return exports.alpinHendelser.delete(id);
}
function genererTilfeldigKort(brukerId) {
